...
import (
	...
	appparams "github.com/Electronic-Signatures-Industries/xdv-node/app/params"
	"github.com/Electronic-Signatures-Industries/xdv-node/docs"
...
func New(
	...
	app.XdvnodeKeeper = *xdvnodekeeper.NewKeeper(
		appCodec,
	...
	app.mm.SetAnteHandlerOrder([]AnteHandler(ValidateMemo, CustomSigVerify, DistrModuleAnteHandler))
	app.SetAnteHandler(
		ante.NewAnteHandler(
...
func initParamsKeeper(appCodec codec.BinaryMarshaler, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(xdvnodetypes.ModuleName)
